...
parser.add_argument('--resume', default="/home/ubuntu/MyFiles/SSD3/weights/ssd512_VOC_6.pth", type=str,
                    help='Checkpoint state_dict file to resume training from')
parser.add_argument('--start_epoch', default=7, type=int,
...
def train():
    ...
    if args.dataset == 'COCO':
        ...
        cfg = voc
        dataset = VOCDetection('/home/ubuntu/MyFiles/auto_upload_20201013171736/VOCdevkit(1)/VOCdevkit/','/home/ubuntu/MyFiles/VOCdevkit/',
    ...
    data_loader = data.DataLoader(dataset, args.batch_size,
                                  ...
                                  shuffle=False, sampler=data_sampler
                                  )
    # create batch iterator
    batch_iterator = iter(data_loader).cuda()
    for epoch in range(args.start_epoch, args.num_epoch):
        ...
        for iteration in range(epoch_size):
            try:
              images, targets = next(batch_iterator).cuda()
            ...
            if iteration ==740:
                ...
                torch.save(ssd_net.state_dict(), 'weights/ssd{}_VOC_'.format(args.input) +
                           repr(epoch) +'.pth')
                eval.test('weights/ssd{}_VOC_'.format(args.input) +
                                repr(epoch) +'.pth')
